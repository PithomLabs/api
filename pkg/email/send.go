...
func SendMail(user *db.User) {
	...
	msg.SetBody("text/html", "<h1>Komfy email verification</h1> Confirm email by clicking on this <a href='api.komfy.now.sh/verify?verify_code=%v'>link</a>.", user.UserID)
