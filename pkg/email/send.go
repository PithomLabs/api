...
func SendMail(user *db.User) {
	...
	msg.SetBody("text/html", fmt.Sprintf("<h2>Komfy email verification</h2> Confirm email by clicking on this <a href='https://api.komfy.now.sh/verify?verify_code=%v'>link</a>.", user.UserID))
